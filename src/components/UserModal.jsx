...
export const UserModal = ({ setChatScreen }) => {
  return (
    <div
      id="usersModal"
      className="absolute left-1/2 px-2 transform -translate-x-1/2 min-w-96 border-2 border-gray-700 border-opacity-20 rounded-2xl flex flex-col items-center bg-gray-600 bg-opacity-40 justify-center"
    >
